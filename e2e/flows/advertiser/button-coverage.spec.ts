...
// Advertiser button coverage — walks every end-user page an
// advertiser sees. Sensitive labels are skipped to avoid mutating
// real records; depth specs handle Add Balance submission etc.
