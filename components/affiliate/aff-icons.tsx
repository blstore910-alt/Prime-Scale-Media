// AUTO-GENERATED icon sprite (verbatim from affiliate-jackpot-light.html).
export function AffIcons() {
  return (
  ...
  {/* Borrowed from the advertiser sprite: RangePicker, the commissions
      card and the payout card are shared with the advertiser's
      Affiliate program screen and draw these three. */}
  ...
  <symbol id="i-building" viewBox="0 0 24 24"><rect width="16" height="20" x="4" y="2" rx="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M8 10h.01"/><path d="M16 10h.01"/></symbol>
  ...
  <symbol id="i-card" viewBox="0 0 24 24"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></symbol>
  ...
  <symbol id="i-arrows" viewBox="0 0 24 24"><path d="m17 3 4 4-4 4"/><path d="M21 7H3"/><path d="m7 21-4-4 4-4"/><path d="M3 17h18"/></symbol>
  <symbol id="i-plus" viewBox="0 0 24 24"><path d="M5 12h14"/><path d="M12 5v14"/></symbol>
</defs></svg>
  );
}

// <use href="#i-x"> icon helper matching the mockup markup.
