...
-- =====================================================================
-- Auto-generated by scripts. Contains 8 migrations in the correct order.
...
-- If pg_cron isn't enabled (needs Pro plan), migration 5's schedule
-- statements will skip silently — the rest still deploys.
-- =====================================================================
