-- =====================================================================
-- WAT ER NOG MOET. Plak dit hele bestand en draai het.
-- =====================================================================
--   DEEL 1  Een afgewezen ad-account-aanvraag geeft de 50 EUR terug.
--   DEEL 2  Vervangt de clawback-functie (zelfde fix als deel 1: een
--           record-veld kan niet binnen een SQL-statement staan). Veilig,
--           ook als je hem al draaide.
--   DEEL 3  De wallet-integriteitscontrole. ALLEEN LEZEN, zes vragen.
--
-- De belangrijkste uitkomst is DEEL 3, VRAAG 1: de kolommen
-- eur_unexplained en usd_unexplained. Die horen 0.00 te zijn. Draai hem
-- nu, en nog eens na de doorloop, dan kun je die twee vergelijken.
--
-- NIET HIERIN, met opzet: money_to_numeric. Die herschrijft opgeslagen
-- waarden in 21 kolommen. Eerst een backup, dan alleen draaien.
--
-- Al binnen en niet nodig: reprice_is_owner_only, yearly_plans,
-- plan_features, commission_clawback, tax_rates,
-- reject_cannot_strand_an_advance.
-- =====================================================================
